...
public class KingMovesCalculator {
    ...
    public Collection<ChessMove> pieceMoves(ChessBoard board, ChessPosition myPosition, ChessGame.TeamColor pieceColor,ChessPiece.PieceType type) {
        ...
        for(int up = row+1, once=1; up <= 8 && once<2; once++){
        ...
        for(int down = row-1, once=1; down >= 1 && once<2; once++){
            //Checks it there is a piece
        ...
        for(int right = column+1, once=1; right <= 8 && once<2; once++){
            //Checks it there is a piece
        ...
        for(int left = column-1, once=1; left >= 1 && once<2; once++){
            //Checks it there is a piece
        ...
        for (int up = row + 1, right = column + 1, once=1; up <= 8 && right <=8 && once<2; once++) {
            //Checks it there is a piece
        ...
        for (int up = row + 1, left = column - 1, once=1; up <= 8 && left >=1 && once<2; once++) {
            //Checks it there is a piece
        ...
        for (int down = row - 1, right = column + 1, once=1; down >= 1 && right <=8 && once<2; once++) {
            //Checks it there is a piece
        ...
        for (int down = row - 1, left = column - 1, once=1; down >= 1 && left >=1 && once<2; once++) {
            //Checks it there is a piece
